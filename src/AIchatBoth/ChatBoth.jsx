                    ...
                    <div className="border-t border-gray-100 p-3">
                        <div className="flex gap-2">
                            <input
                                ...
                                className="flex-1 rounded-xl border px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-green-500"
                            />
                            <button
                                onClick={sendMessage}
                                disabled={loading || !input.trim()}
                                className="bg-green-600 text-white rounded-xl px-3 py-2 text-sm disabled:opacity-50"
                            >
                                Send
                            </button>
                        </div>
