...
const Banner = () => {
    return (
        <section className="relative overflow-hidden min-h-[85vh] flex items-center justify-center px-6 md:px-20 py-12 bg-gradient-to-r from-green-100 via-white to-orange-100">
